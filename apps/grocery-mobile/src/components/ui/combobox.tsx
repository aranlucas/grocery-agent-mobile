...
export function Combobox({
  ...
  return (
    <View className={cn("", className)} {...props}>
      ...
      <Pressable
        className={cn(
          "min-h-12 flex-row items-center justify-between rounded-md border bg-background px-4",
      ...
      <Modal visible={open} transparent animationType="fade" onRequestClose={() => setOpen(false)}>
        ...
        >
          <Pressable className="max-h-96 rounded-t-2xl bg-card pb-8" onPress={() => {}}>
            ...
            {groups ? (
              <SectionList
                ...
                renderSectionHeader={({ section }) => (
                  <View className="bg-card px-5 py-2">
                ...
                ListEmptyComponent={
                  <Text className="py-4 text-center text-muted-foreground">{emptyText}</Text>
                }
              />
            ) : (
              <FlatList
