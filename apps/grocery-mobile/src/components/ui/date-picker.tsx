...
function TriggerButton({
  ...
  return (
    <Pressable
      className={cn(
        "min-h-12 flex-row items-center rounded-md border border-input bg-background px-4",
        className,
      )}
      onPress={onPress}
      accessible={true}
    ...
    >
      <Text
        className={cn("flex-1 text-base", hasValue ? "text-foreground" : "text-muted-foreground")}
      >
        {label}
      </Text>
