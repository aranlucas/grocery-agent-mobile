...
const kbdVariants = cva("items-center justify-center rounded-md border border-border bg-muted", {
  variants: {
    size: {
      sm: "min-h-5 px-1",
      md: "min-h-6 px-1.5",
...
export interface KbdProps
  extends React.ComponentPropsWithoutRef<typeof View>, VariantProps<typeof kbdVariants> {
  className?: string;
