...
| Hosting | Node.js server or compatible self-hosted runtime | Any static host (Netlify, Vercel, S3) |
...
| **Hosting** | Node.js server or compatible self-hosted runtime | Any static host |
